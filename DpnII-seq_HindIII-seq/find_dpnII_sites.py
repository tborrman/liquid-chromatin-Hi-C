...
parser=argparse.ArgumentParser(description='record dpnII sites for given chromosome FASTA in bed file format')
...
coords = Restriction.DpnII.search(seq_record.seq)

chrom = seq_record.id
OUT=open('dpnII_sites_' + chrom + '.bed', 'w')
for start in coords:
