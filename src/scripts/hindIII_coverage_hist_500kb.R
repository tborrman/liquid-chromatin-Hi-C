...
parser <- ArgumentParser(description="create histogram of HindIII read coverage ")
...
hist(df$reads, breaks=seq(0, max(df$reads) + 10, 10), lty="blank", col="gray60",
 ...
 main = "", freq=FALSE, ylim=c(0,0.0008))

# 1st Gaussian
mu = 3355.34
sigma = sqrt(221187.34)
