...
hp1_na <- df[c("half-life_LOS", "CBX1_R1", "CBX5", "LAD_K562", 
               "H3K9me3_R1","PCA_eigen1")]
colnames(hp1_na) <- c("hl", "CBX1_R1", "CBX5", "LAD", "H3K9me3", "PCA_eigen1")
hp1 <- na.omit(hp1_na)
...
#######################################################################################################################
# B Compartments
pdf(paste("B/half-life_Bcomp_density.pdf", sep=""),
          width=7, height=6)
      print(
      ggplot() + 
...
pdf(paste("B/half-life_Bcomp_cumulative.pdf", sep=""),
    width=7, height=6)
print(
  ggplot() + 
...
####################################################################################################################
# A Compmartments     
pdf(paste("A/half-life_Acomp_density.pdf", sep=""),
    width=7, height=6)
print(
  ggplot() + 
