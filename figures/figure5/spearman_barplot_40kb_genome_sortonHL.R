...
new_labels <- c("half-life_LOS", "H3K36me3", "H3K27ac", "H3K4me1", "H4K20me1",
  ...
  myorder <- rev(c(20, 15, 16, 13, 6, 10, 21, 3, 8, 5, 17, 23, 24, 4, 22, 2, 19, 1, 9, 25, 12, 14, 18, 7, 11))
  order_bar <- bar_df[myorder,]
  ...
  pdf("cor_los_halflife_40kb_genome_sortonHL.pdf", height=8, width=7.5)
